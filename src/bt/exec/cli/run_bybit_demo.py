...
def main() -> None:
    ...
    run_exec_session(config_path=args.config, data_path=args.data, mode="paper_broker", out_dir=args.out_dir, override_paths=args.override or None, run_id=args.run_id)
